  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-black to-gray-900 font-poppins text-white">
      ...
      <div className="container mx-auto px-4 pt-6">
        {/* Back Button */}
        <Link to="/Dashboard">
          <button className="flex items-center gap-2 text-gray-300 hover:text-cyan-400 transition-colors mb-6 text-sm">
        ...
        <div className="max-w-2xl mx-auto bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 shadow-2xl">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300 mt-1 text-sm">Better luck on the next one!</p>
          
            {/* Points Section - MAIN FOCUS */}
            <div className="mt-4">
              <div className="inline-block px-6 py-3 bg-gradient-to-r from-red-900/40 to-red-800/30 rounded-xl border-2 border-red-500/40 shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-red-200 text-sm">Deducted from your total points</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-gray-900/50 to-black/50 border border-gray-700/30 rounded-lg p-4 mb-6">
            <div className="text-gray-400 text-xs mb-2">You attempted:</div>
